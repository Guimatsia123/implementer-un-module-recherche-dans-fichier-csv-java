...
public class CoursFinance {
    ...
    * @param niveauExperience     le niveau d'experience requis pour prendre ce
    *                             cours
    ...
    * [evaluation/nbEvaluations] | (duree min) | prix | date et heure de
    * publication
    * 
   ...
   /**
    * Deux cours sont consideres egaux si leurs attributs titre (sans tenir compte
    * de la casse),
    * dateHeurePublication, et duree sont egaux. Si obj est null, cette methode
    * retourne false.
    * 
